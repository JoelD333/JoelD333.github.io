...
var csvUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQu6otjfmsQT2zalevW9CCzdma2hrnyx5zOTAYfCLqX1_rpnmb1-BoZeUdcbxWliXcFcYFRKB4aCW78/pub?gid=386903556&single=true&output=csv";
    ...
    .then(data => {
      ...
      for (var i = 1; i < lines.length; i++) {
       ...
       var tb =  document.createElement("tbody");
        ...
        var cellHermano = row.insertCell();
        cellHermano.textContent = cells[1];       
